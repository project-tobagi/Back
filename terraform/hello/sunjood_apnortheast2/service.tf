...
module "hello" {
  ...
  # Route53 variables
  acm_external_ssl_certificate_arn = var.r53_variables.id.star_sunjoo_com_acm_arn_apnortheast2
  route53_external_zone_id         = var.r53_variables.id.sunjoo_com_zone_id
