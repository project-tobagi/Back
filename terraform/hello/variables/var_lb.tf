  ...
  default = {
    ...
    external_lb = {
      tags = {
        ...
        sunjoodapne2 = {
          Name    = "hello-sunjood_apnortheast2-external-lb"
          app     = "hello"
          project = "hello"
          env     = "dev"
          stack   = "sunjood_apnortheast2"
        },

        buevonhundapne2 = {
          Name    = "hello-buevonhund_apnortheast2-external-lb"
          app     = "hello"
          project = "hello"
          env     = "dev"
          stack   = "buevonhund_apnortheast2"
        },
    ...
    external_lb_tg = {
      tags = {
        ...
        sunjoodapne2 = {
          Name    = "hello-sunjood_apnortheast2-external-tg"
          app     = "hello"
          project = "hello"
          env     = "dev"
          stack   = "sunjood_apnortheast2"
        ...
        buevonhundapne2 = {
          Name    = "hello-buevonhund_apnortheast2-external-tg"
          app     = "hello"
          project = "hello"
          env     = "dev"
          stack   = "buevonhund_apnortheast2"
