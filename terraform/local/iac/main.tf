...
#   volumes {
#     host_path      = "/Users/kimsunjoo/Desktop/spring_study/hello-spring/terraform/local/iac/mysql_master/init.sql"
#     container_path = "/docker-entrypoint-initdb.d/init.sql"
#   }
  volumes {
    host_path      = "/Users/kimsunjoo/Desktop/spring_study/hello-spring/terraform/local/iac/mysql_master" #/my.cnf"
    container_path =  "/docker-entrypoint-initdb.d" #"/etc/mysql/my.cnf"
  }
  networks_advanced {
